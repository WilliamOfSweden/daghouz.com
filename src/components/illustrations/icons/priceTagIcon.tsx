...
const PriceTagIcon: FC = () => {
    ...
    return (
        ...
        <StyledSVG id='e1eaa5f7-9ff6-4e61-ad1b-e71b0b25c5d9' data-name='Layer 1' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 177.426 200'>
            ...
            <path className='e0a17bed-a420-40f9-bb55-9834376bb18f' d='M165.15,71.308,147.292,11.313a9.962,9.962,0,0,0-11.859-6.847L74.547,19a9.728,9.728,0,0,0-6.57,5.159L1.344,139.571A10.016,10.016,0,0,0,5.01,153.254l78.64,45.4a10.015,10.015,0,0,0,13.682-3.666L163.966,79.578A9.734,9.734,0,0,0,165.15,71.308ZM113.786,55.654a16.243,16.243,0,1,1,22.188-5.946A16.242,16.242,0,0,1,113.786,55.654Z' transform='translate(0 0)'/>
