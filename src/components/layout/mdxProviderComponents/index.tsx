...
const MDXheading2: FC<Props> = ({ children }) => <Typography align='center' variant='h2'>{ children }</Typography>
...
export const MDXheading2small: FC<Props> = ({ children }) => <Typography component='h2' variant='h3'>{ children }</Typography>
